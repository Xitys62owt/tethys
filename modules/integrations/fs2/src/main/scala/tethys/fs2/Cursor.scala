...
private[tethys] final class Cursor private (jsonParser: JsonParser) {
  import Cursor._

  private val inputFeeder: ByteArrayFeeder =
...
private[tethys] object Cursor {
  private lazy val defaultJsonFactory: JsonFactory = {
